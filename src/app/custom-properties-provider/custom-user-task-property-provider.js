...
import customUserTaskProperties from './properties/custom-user-task-properties';
...
function createCustomGroup(element, translate) {
  ...
  const customGroup = {
    id: 'customUserTask',
    label: translate('Custom properties user task'),
    entries: customUserTaskProperties(element)
  };
